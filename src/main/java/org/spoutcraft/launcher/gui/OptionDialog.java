...
public class OptionDialog extends JDialog implements ActionListener {
	...
	public OptionDialog() {
		setTitle("Adrenaline Launcher Settings");
		...
		buildInfo.setText("Adrenaline Launcher Build " + Main.build);
		buildInfo.setOpaque(true);
		buildInfo.setForeground(Color.DARK_GRAY);
		buildInfo.setToolTipText("Created by the Spout Development Team and Modified by the Technic Team, and then Modified again for use by Adrenaline Gaming. Licensed under the LGPL. Source code is available at www.github.com/SpoutDev");
